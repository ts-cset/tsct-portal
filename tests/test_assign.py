...
def test_assign_create(client):
    ...
    assert client.get('/course/180/session/2/create/assignment/').status_code == 302
    ...
    assert client.get('/course/180/session/2/create/assignment/').status_code == 200
    #check response data for response assign create
    response = client.get('/course/180/session/2/create/assignment/')
...
def test_create_errors(client, name, description, points, due_date, error):
    ...
    response = client.post('/course/180/session/2/create/assignment/', data={'name': name,
